...
This extension will take all of your Auth0 logs and export them to Splunk.
...
$ wt cron schedule \
    ...
    --secret SPLUNK_TOKEN="SPLUNK_TOKEN" \
    "*/5 * * * *" \
    build/bundle.js
```
...
Information on setting this up in Splunk Enterprise / Splunk Cloud here:

[Introduction to Splunk HTTP Event Collector](http://dev.splunk.com/view/event-collector/SP-CAAAE6M)

[Setup and use Splunk HTTP Event Collector](http://docs.splunk.com/Documentation/Splunk/6.4.0/Data/UsetheHTTPEventCollector)
